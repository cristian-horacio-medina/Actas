...
<div class="col-md-1"> 
    ...
    <div class="col-md-1"> 
        <?php 
            //$fecha=$dato['Fecha'];
            $fecha1=(str_replace('-','/',date('m', strtotime($FExamen))));?>
    ...
    <div class="col-md-2">
        ...
        <h4>Libro: <input type="text" value="<?php $actasl=$dato['Acta']; $libro=explode("/", $actasl); echo $libro[0];?>" name="Libro"></h4>
        <h4>Folio: <input type="text" value="<?php $actasf=$dato['Acta']; $libro=explode("/", $actasf); echo $libro[1];?>" name="Folio"></h4>
    </div>
    <hr>
    <?php } ;?>  
     <br>   
