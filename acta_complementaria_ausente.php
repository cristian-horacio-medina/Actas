...
<html lang="es" dir="ltr">
  ...
  <body>
      ...
      <input type="button" class="invisible" onclick="location.href='index.php';" value="Inicio" />
      <div>
    <div class="page">
    ...
    <thead>
      ...
      </tr></table><br /><p style="margin: 1px auto 1px 200px"><b>Totales de alumnos  a Examinar:</b> 1</p><p style="margin: 1px auto 1px 200px"><b>Total de alumnos Aprobados:</b> 0</p><p style="margin: 1px auto 1px 200px">
      <b>Total de alumnos Desaprobados:</b> <?php if($_GET['nota']<4){echo 1;}else{echo 0;} ?></p><p style="margin: 1px auto 1px 200px"><b>Total de alumnos Ausentes:</b> <?php if($_GET['nota']=='x'){echo 1;}else{echo 0;}?></p><br><p><b>Firmas:</b></p><br><table style="border: hidden">
    <tr>
