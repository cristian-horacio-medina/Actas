...
<html lang="es" dir="ltr">
  ...
  <body >  <!---onload="imprimir();"-->
    ...
    <div class="box w50 col p10">
      <img style="width:100px" src="img/logo-faecc.png">
      <!---src="https://mifaecc.edu.ar/apk/administrativo_php/public/export/print/img/logo-faecc.png"--->          
    ...
    $tipo_examen = $_GET['tipo_mesa'];
      ...
      <div class="box b1 p10">
        <div><p>Libro: <?php echo $_GET['Libro'];?></p></div>
        <div><p>Folio: <?php echo $_GET['Folio'];?></p></div>
        </div>
      </div>
    </div>
    ...
    <thead>
      ...
      <tr>
        ...
        <td class="text-center"><?php echo $_GET['nota']; ?></td >

        <td class="text-center"><?php echo $_GET['nota_en_letras']; ?></td>
      </tr></table><br /><p style="margin: 1px auto 1px 200px"><b>Totales de alumnos  a Examinar:</b> 1</p><p style="margin: 1px auto 1px 200px"><b>Total de alumnos Aprobados:</b> 1</p><p style="margin: 1px auto 1px 200px"><b>Total de alumnos Desprobados:</b> 0</p><p style="margin: 1px auto 1px 200px"><b>Total de alumnos Ausentes:</b> 0</p><br><p><b>Firmas:</b></p><br><table style="border: hidden">
    <tr>
